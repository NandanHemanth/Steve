...
export const stevensCourses = [
    ...
    },
    {
        ...
        credits: 3,
        description: "Dashboards and storytelling using analytics outputs. Instructor rosters finalize in Workday each term.",
        prerequisites: [],
        workload: "Medium",
...
export const stevensPolicies = {
    f1: {
        ...
        note: "Rule-of-thumb only. Always confirm with Stevens ISSS for your specific situation and term rules (e.g., final semester, RCL, thesis).",
        onlineCreditReminder: "Online course limits and exceptions vary. Ask ISSS if a course is online/hybrid and you’re near the limit."
    },
    tuition: {
        note: "Demo estimates. Replace with official Stevens tuition tables for your program/term in production.",
        perCreditUSD: {
            Undergraduate: 1600,
            Masters: 2200,
            PhD: 2200,
